...
public class wlc_screen_old_with_multithreading extends javax.swing.JFrame implements Runnable {
    int s= 0;
    Thread th;
    
    public wlc_screen_old_with_multithreading() {
       super("wlc_screen");
    ...
    public void startLoading(){
        ...
        try{            
            ...
            if(!lgObj.autoLogin()){
                ...
                System.out.println("executing new faceLoginWelcome ");
                faceLoginWelcome flwObj=new faceLoginWelcome(lgObj.UserNameToPrint,lgObj.autoLoginUserName);
                //Thread.sleep(1000);
                flwObj.setVisible(true);
                System.out.println("showing auto login welcome screen ");
                Thread.sleep(3000);
                System.out.println("executing new faceLoginWelcome");
                lgObj.dispose();
                new home().setVisible(true);
                flwObj.setVisible(false);            
              
            }else{
                
                System.out.println("executing new faceLoginWelcome else ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(wlc_screen_old_with_multithreading.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new wlc_screen_old_with_multithreading().setVisible(true);
            }
        });
    }
