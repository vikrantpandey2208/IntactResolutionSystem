 ...
 */
public class search_student_irs extends javax.swing.JFrame {
  ...
  jTable2.setDefaultRenderer(String.class, center_render);
   jTable2.setDefaultRenderer(Integer.class, center_render);
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "student_id", "name", "fname", "class", "branch", "admission_year", "" }));
   ...
   jTable2.setDefaultRenderer(Integer.class, center_render);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(search_student_irs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
