 ...
 */
public class search_book_irs extends javax.swing.JFrame {
   ...
   jTable2.setDefaultRenderer(Integer.class, center_render);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(search_book_irs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
