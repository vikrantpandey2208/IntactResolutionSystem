 ...
 */
public class search_returned_book extends javax.swing.JDialog {
    Connection conn;
     adddata add= new adddata();
    /**
     * Creates new form searchIssuedBooks
     */
    public search_returned_book(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    String sql=  "select  b.book_id as b_id, b.name as b_name, b.writer as writer, "+
   ...
   jTable2.setDefaultRenderer(Integer.class, center_render);
    ...
    while(rs.next()){
        ...
        for(int i=0; i<=c; i++){
            ...
            v2.add(df.format(rs.getDate("return_date")));
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Search Returned Book");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "book_id", "Book Name", "writer", "student_id", "Student Name", "class", "issue_date", "return_date" }));
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Serial", "Book Id", "Book Name", "Book Writer", "Student Id", "Student Name", "Class", "Issue Date", "Return Date"
            }
        ) {
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        String search_table= "return_book";
if((index!=7) && (index!= 8)){
        try{
            power obb = new power();
    ...
    private void jComboBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox1ItemStateChanged
        ...
        if(search_column.equals("All")){
            ...
            jTextField1.disable();
             jLabel1.hide();
            jButton4.hide();
        }else if(search_column.equals("issue_date")||search_column.equals("return_date")){
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try{
            ...
            ResultSet rs= obb.ReturnDateSearch(index, search_key,search_column,search_table);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(search_returned_book.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                search_returned_book dialog = new search_returned_book(new javax.swing.JFrame(), true);
